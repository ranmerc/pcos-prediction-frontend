...
export default function FormMarkup(props: any) {
  ...
  return (
    <Stack component="form" rowGap={4} width={"80%"} onSubmit={handleSubmit}>
      ...
      <NumberInput
        ...
        step="0.01"
      />
      <NumberInput label="Regular Period Cycle (Length)" name="regularCycle" />
      ...
      <RadioInput label="Do you seem to be getting more acne?" name="pimples" />
